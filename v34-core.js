(() => {
  ...
  function ensureControlCoins(){let u=controlUser();if(!u)return null;const k=CONTROL_COIN_GRANT_PREFIX+u.id;if(!Number.isFinite(Number(u.coins))){u=updateControlUser(u.id,{coins:5000})||{...u,coins:5000};localStorage.setItem(k,'1');}return u;}
