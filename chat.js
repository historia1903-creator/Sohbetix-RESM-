(() => {
  ...
  function renderMessages(forceBottom = false) {
    ...
    els.messages.innerHTML = list.filter(msg=>!msg.nick || !isBlockedWithV30(msg.nick)).map(msg => {
